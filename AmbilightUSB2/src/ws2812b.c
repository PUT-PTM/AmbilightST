...
/*
	// G
	*(LED_OutputBuffer_Pointer +          0 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer +          1 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer +          2 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer +          3 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer +          4 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer +          5 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer +          6 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer +          7 * 3 + 1) = 1;

	// R
	*(LED_OutputBuffer_Pointer + 8  * 3 + 0 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 1 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 2 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 3 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 4 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 5 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 6 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 8  * 3 + 7 * 3 + 1) = 1;

	// B
	*(LED_OutputBuffer_Pointer + 16  * 3 + 0 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 1 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 2 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 3 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 4 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 5 * 3 + 1) = 1;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 6 * 3 + 1) = 0;
	*(LED_OutputBuffer_Pointer + 16  * 3 + 7 * 3 + 1) = 1;
	...
	for(i=0; i<8; i++)
	{
		*(LED_OutputBuffer_Pointer +          i * 3 + 1)  = ((G >> 7-i) & 0x01);
		*(LED_OutputBuffer_Pointer + 8  * 3 + i * 3 + 1)  = ((R >> 7-i) & 0x01);
		*(LED_OutputBuffer_Pointer + 16 * 3 + i * 3 + 1)  = ((B >> 7-i) & 0x01);
	}
